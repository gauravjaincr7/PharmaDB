	...
	<div class="align-center">
		<div class="card" style="display: inline-block;padding: 50px;">
			<form method="post" action="" style="width: 40vw; text-align: left;">
				...
				<input type="text" name="FIRST_NAME" placeholder="10 chars max" >
				
				<br><br>

				<label>Enter MID NAME</label>
				<input type="text" name="MID_NAME" placeholder="NUM">
				
				<br><br>

				<label>Enter LAST NAME</label>
				<input type="text" name="LAST_NAME" placeholder="NUM">
				
				<br><br>

				<label>Enter SPECIALIZATION</label>
				<input type="text" name="SPECIALIZATION" placeholder="CHAR">
				
				<br><br>

				<!-- <label>Enter SPECIALIZATION</label>
				<input type="text" name="SPECIALIZATION" placeholder="NUM"> -->
	...
	<?php
		if(!empty($_POST))
		{
			if ($_POST['Action'] == 'Insert') 
			{
				...
				$sql = "INSERT INTO doctor (DOCTOR_ID,FIRST_NAME,MIDDLE_NAME,LAST_NAME)
				VALUES ( '$_POST[DOCTOR_ID]','$_POST[FIRST_NAME]','$_POST[MID_NAME]','$_POST[LAST_NAME]')
				; ";
				...
				$sql="INSERT INTO SPECIALIZATION (DOCTOR_ID,SPECIALIZATION) VALUES ('$_POST[DOCTOR_ID]','$_POST[SPECIALIZATION]')";
			...
			else if ($_POST['Action'] == 'Delete') 
			{
				...
				/*$sql = "DELETE FROM doctor WHERE
				 DOCTOR_ID = '$_POST[DOCTOR_ID]' and FIRST_NAME = '$_POST[FIRST_NAME]' and MIDDLE_NAME ='$_POST[MID_NAME]' and LAST_NAME ='$_POST[LAST_NAME]' ";*/
