...
<body style="background-image:url(https://www.boswellpharmacy.com/wp-content/uploads/2017/01/ThinkstockPhotos-5433376822.jpg)">
	...
	<div class="align-center">
		<div class="card" style="display: inline-block;padding: 50px;">
			<form method="post" action="" style="width: 40vw; text-align: left;">
				...
				<input type="text" name="SPECIALIZATION" placeholder="10 chars max" >
	...
	<!--html way of linking-->
	<form action="specialization_show.php">
	...
	<?php
		if(!empty($_POST))
		{
			if ($_POST['Action'] == 'Insert') 
			{
				...
				$sql = "INSERT INTO specialization (DOCTOR_ID, SPECIALIZATION)
				VALUES ( '$_POST[DOCTOR_ID]','$_POST[SPECIALIZATION]' )";
			...
			else if ($_POST['Action'] == 'Delete') 
			{
				...
				$sql = "DELETE FROM specialization WHERE
				 DOCTOR_ID = '$_POST[DOCTOR_ID]' and SPECIALIZATION = '$_POST[SPECIALIZATION]' ";
