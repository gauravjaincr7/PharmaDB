	...
	<div class="align-center">
		<div class="card" style="display: inline-block;padding: 50px;">
			<form method="post" action="" style="width: 40vw; text-align: left;">
				...
				<input type="text" name="FIRST_NAME" placeholder="MAX 10 CHAR">
				...
				<input type="text" name="CONTACT" placeholder="NUM">
	...
	<?php
		if(!empty($_POST))
		{
			if ($_POST['Action'] == 'Insert') 
			{
				...
				$sql = "INSERT INTO patient (PATIENT_ID,DOCTOR_ID,FIRST_NAME,MIDDLE_NAME,LAST_NAME,SEX,CONTACT,ADDRESS)
				VALUES ( '$_POST[PATIENT_ID]','$_POST[DOCTOR_ID]','$_POST[FIRST_NAME]','$_POST[MIDDLE_NAME]','$_POST[LAST_NAME]','$_POST[SEX]','$_POST[CONTACT]','$_POST[ADDRESS]' )";

				/*$sql = "INSERT INTO patient (PATIENT_ID,FIRST_NAME,MIDDLE_NAME,LAST_NAME,SEX,CONTACT,ADDRESS)
				VALUES ( '$_POST[PATIENT_ID]','$_POST[FIRST_NAME]','$_POST[MIDDLE_NAME]','$_POST[LAST_NAME]','$_POST[SEX]','$_POST[CONTACT]','$_POST[ADDRESS]' )";*/
			...
			else if ($_POST['Action'] == 'Delete') 
			{
				...
				/*$sql = "DELETE FROM patient WHERE
				 PATIENT_ID = '$_POST[PATIENT_ID]' and DOCTOR_ID = '$_POST[DOCTOR_ID]' and FIRST_NAME ='$_POST[FIRST_NAME]' and MIDDLE_NAME ='$_POST[MIDDLE_NAME]' and LAST_NAME ='$_POST[LAST_NAME]' and SEX ='$_POST[SEX]' and CONTACT ='$_POST[CONTACT]' and ADDRESS ='$_POST[ADDRESS]' ";*/
