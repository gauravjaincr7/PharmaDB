...
<body style="background-image:url(https://www.boswellpharmacy.com/wp-content/uploads/2017/01/ThinkstockPhotos-5433376822.jpg)">
	...
	<?php  
			...
			//echo "\n \n Connected successfully";
				...
				$sql = "SELECT * FROM DOCTOR"; //We don't need a ; like we do in SQL
			...
			else
			{
				...
				$sql = "SELECT * FROM DOCTOR WHERE FIRST_NAME = '$_POST[Filter]' ";
    ...
    <div class="container">
		<table class="striped card">
			...
			echo "<tr><th>"."DOCTOR ID"."</th><th>"."FIRST NAME"."</th><th>"."MIDDLE NAME"."</th><th>"."LAST NAME"."</th></tr>";// tr- row , th - head cell , td - standard cell -->
	<?php
			while($row = mysqli_fetch_array($result))
			{

	?>
				<!-- echo "<tr><td>" . $row["DOCTOR_ID"] . "</td><td>" . $row["FIRST_NAME"] . "</td><td>".$row["MIDDLE_NAME"] ."</td><td>".$row["LAST_NAME"] ."</td></tr>";  //$row['index'] the index here is a field name -->
				<tr>
