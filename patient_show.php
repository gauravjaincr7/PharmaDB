...
<body style="background-image:url(https://www.boswellpharmacy.com/wp-content/uploads/2017/01/ThinkstockPhotos-5433376822.jpg)">
	...
	<?php  
			...
			//echo "\n \n Connected successfully";
				...
				$sql = "SELECT * FROM PATIENT"; //You don't need a ; like you do in SQL
			...
			else
			{
				...
				$sql = "SELECT * FROM PATIENT WHERE FIRST_NAME = '$_POST[Filter]' ";
 	...
 	?>
			...
			echo "<tr><th>"."PATIENT ID"."</th><th>"."DOCTOR ID"."</th><th>"."FIRST NAME"."</th><th>"."MIDDLE NAME"."</th><th>"."LAST NAME"."</th><th>"."SEX"."</th><th>"."CONTACT"."</th><th>"."ADDRESS"."</th></tr>";// tr- row , th - head cell , td - standard cell -->
	<?php 		
	...
	?>
				...
				<!-- echo "<tr><td>" . $row["PATIENT_ID"] . "</td><td>" . $row["DOCTOR_ID"] . "</td><td>".$row["FIRST_NAME"] ."</td><td>".$row["MIDDLE_NAME"] ."</td><td>".$row["LAST_NAME"] . "</td><td>".$row["SEX"] . "</td><td>".$row["CONTACT"] . "</td><td>".$row["ADDRESS"] . "</td></tr>";  //$row['index'] the index here is a field name -->
