	...
	<div class="align-center">
		<div class="card" style="display: inline-block;padding: 50px;">
			<form method="post" action="" style="width: 40vw; text-align: left;">
				...
				<input type="text" name="PHARMACY_ID" placeholder="NUM" >
				<br><br>
	...
	<?php
		if(!empty($_POST))
		{
			if ($_POST['Action'] == 'Insert') 
			{
				...
				$sql = "INSERT INTO pharmacy (PHARMACY_ID, NAME, ADDRESS)
				VALUES ( '$_POST[PHARMACY_ID]','$_POST[NAME]','$_POST[ADDRESS]' )";
			...
			else if ($_POST['Action'] == 'Delete') 
			{
				...
				/*$sql = "DELETE FROM pharmacy WHERE
				 PHARMACY_ID = '$_POST[PHARMACY_ID]' and NAME = '$_POST[NAME]' and ADDRESS='$_POST[ADDRESS]' ";*/
